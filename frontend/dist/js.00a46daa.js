...
var _default = _vue.default.observable(obj);
...
},{}],"js/componentes/Login.vue":[function(require,module,exports) {
"use strict";
            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (data.status === "error") {
                  ...
                  _this.app.token = data.msg;
                  _this.app.iniciado = true;
...
exports.default = _default;
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("button", { on: { click: _vm.iniciarSesion } }, [_vm._v("Acceder")])
  ])
}
var staticRenderFns = []
...
},{"../config":"js/config.js","../store":"js/store.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"js/componentes/Dashboard.vue":[function(require,module,exports) {
"use strict";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this.app.connection.onmessage = function (event) {
                _this.actualizar();
              };
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch("".concat(be, "/").concat(_this2.direccion), {
                  headers: {
...
exports.default = _default;
        var $f74a99 = exports.default || module.exports;
      
      if (typeof $f74a99 === 'function') {
        $f74a99 = $f74a99.options;
      }
    
        /* template */
        Object.assign($f74a99, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f74a99', $f74a99);
          } else {
            api.reload('$f74a99', $f74a99);
          }
        }
...
exports.default = _default;
        var $bdcd82 = exports.default || module.exports;
      
      if (typeof $bdcd82 === 'function') {
        $bdcd82 = $bdcd82.options;
      }
    
        /* template */
        Object.assign($bdcd82, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bdcd82', $bdcd82);
          } else {
            api.reload('$bdcd82', $bdcd82);
          }
        }
...
},{"../config":"js/config.js","../store":"js/store.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"js/componentes/VerUno.vue":[function(require,module,exports) {
"use strict";
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch("".concat(be, "/").concat(_this2.direccion, "/").concat(_this2.$route.params.id), {
                  headers: {
                    "x-token": _this2.app.token
                  }
                });
...
exports.default = _default;
        var $af7721 = exports.default || module.exports;
      
      if (typeof $af7721 === 'function') {
        $af7721 = $af7721.options;
      }
    
        /* template */
        Object.assign($af7721, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
},{"../config":"js/config.js","../store":"js/store.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"js/componentes/EditarUsuarios.vue":[function(require,module,exports) {
"use strict";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              _this.apellidos = caf[0].apellidos;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return fetch("".concat(be, "/usuarios/").concat(_this2.$route.params.id), {
                  method: "PUT",
                  headers: {
                    "x-token": _this2.app.token,
                    "Content-Type": "application/json; charset=utf-8"
                  ...
                  body: JSON.stringify({
                    ...
                    nombre_usuario: _this2.usuario,
                    contra: _this2.contra,
                    permisos: _this2.permisos
                  })
                });
...
exports.default = _default;
        var $c1b42e = exports.default || module.exports;
      
      if (typeof $c1b42e === 'function') {
        $c1b42e = $c1b42e.options;
      }
    
        /* template */
        Object.assign($c1b42e, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", [_vm._v("Editar Usuarios")]),
    _vm._v(" "),
    _c("label", [_vm._v("Nombres de Usuario:")]),
    _vm._v(" "),
    _c("input", {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c1b42e', $c1b42e);
          } else {
            api.reload('$c1b42e', $c1b42e);
          }
        }
...
var _Login = _interopRequireDefault(require("./componentes/Login"));

var _Dashboard = _interopRequireDefault(require("./componentes/Dashboard"));
...
var Router = new _vueRouter.default({
  routes: [{
    ...
    path: '/usuarios/:id',
    component: _VerUno.default,
    props: {
      direccion: 'usuarios'
    }
  }, {
    path: '/usuarios/:id/editar',
    component: _EditarUsuarios.default
  }, {
    path: '/cafes',
    component: _VerTodos.default,
    props: {
...
exports.default = _default;
  ...
  return _c(
    "div",
    { attrs: { id: "app" } },
    [_vm.iniciado ? _c("Nav") : _vm._e(), _vm._v(" "), _c("router-view")],
    1
  )
}
var staticRenderFns = []
...
},{"./Nav.vue":"js/componentes/Nav.vue","../store":"js/store.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
var _App = _interopRequireDefault(require("./componentes/App.vue"));
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js","./router":"js/router.js","./componentes/App.vue":"js/componentes/App.vue"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
